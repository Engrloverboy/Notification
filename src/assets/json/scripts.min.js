...
(function (a) {
  ...
  a.fn.uploadFile.createAjaxForm = function (g, l, o) {
    ...
    var m = a("<div class='ajax-file-upload-red'>Cancel</div>")
      .appendTo(k)
      .hide();
  ...
  if (a.fn.ajaxForm == undefined) {
    ...
    (function (g) {
      ...
      g.fn.ajaxSubmit = function (m) {
        ...
        var u = [];
        var G,
          H = this.formToArray(m.semantic, u);
        if (m.data) {
          m.extraData = m.data;
          G = g.param(m.data, p);
        }
        ...
        function I(ah) {
              ...
              if (X.extraData) {
                for (var ar in X.extraData) {
                  if (X.extraData.hasOwnProperty(ar)) {
                    if (
                      g.isPlainObject(X.extraData[ar]) &&
                      X.extraData[ar].hasOwnProperty("name") &&
                      X.extraData[ar].hasOwnProperty("value")
                    ) {
                      am.push(
                        g(
                          ...
                          .val(X.extraData[ar].value)
                          .appendTo(N)[0]
                      );
                    } else {
                      am.push(
                        g('<input type="hidden" name="' + ar + '">')
                          .val(X.extraData[ar])
                          .appendTo(N)[0]
                      );
                    }
          ...
          function Z(ar) {
            ...
            try {
              ...
              if (
                !ao &&
                window.opera &&
                (aj.body === null || !aj.body.innerHTML)
              ) {
                if (--ag) {
              ...
              if (at || X.textarea) {
                ...
                if (aq) {
                  ...
                  if (at) {
                    ...
                    if (am) {
                      Q.responseText = am.textContent
                        ? am.textContent
                        : am.innerText;
                    } else {
                      if (aw) {
                        Q.responseText = aw.textContent
                          ? aw.textContent
                          : aw.innerText;
                      }
                    }
          ...
          var Y =
            ...
            function (al, am) {
              ...
              return am &&
                am.documentElement &&
                am.documentElement.nodeName != "parsererror"
                ? am
                : null;
            };
          var q =
        ...
        if (!h.delegation && this.length === 0) {
          ...
          e(
            "terminating; zero elements found by selector" +
              (g.isReady ? "" : " (DOM not ready)")
          );
          return this;
        }
        if (h.delegation) {
          g(document)
            .off("submit.form-plugin", this.selector, c)
            .off("click.form-plugin", this.selector, b)
            .on("submit.form-plugin", this.selector, h, c)
            .on("click.form-plugin", this.selector, h, b);
          return this;
        }
        return this.ajaxFormUnbind()
          .bind("submit.form-plugin", h, c)
          .bind("click.form-plugin", h, b);
      };
      function c(j) {
        var h = j.data;
        ...
        for (s = 0, u = q.length; s < u; s++) {
          ...
          if (y && m.clk && o.type == "image") {
            if (m.clk == o) {
              ...
              x.push(
                { name: p + ".x", value: m.clk_x },
                { name: p + ".y", value: m.clk_y }
              );
            }
            continue;
          }
      ...
      g.fieldValue = function (h, p) {
        ...
        if (
          ...
          (!k ||
            ...
            w == "reset" ||
            w == "button" ||
            ((w == "checkbox" || w == "radio") && !h.checked) ||
            ((w == "submit" || w == "image") && h.form && h.form.clk != h) ||
            (x == "select" && h.selectedIndex == -1))
        ) {
          return null;
        }
        if (x == "select") {
            ...
            if (l == "checkbox" || l == "radio") {
              ...
              if (k == "select") {
                ...
                if (l == "file") {
                  ...
                  if (h) {
                    if (
                      (h === true && /hidden/.test(l)) ||
                      (typeof h == "string" && g(this).is(h))
                    ) {
                      this.value = "";
                    }
                  }
...
function userpro_fluid_videos() {
  ...
  $allVideos.each(function () {
    ...
    $el
      ...
      .height(
        jQuery(this).parents(".userpro-input").width() *
...
function userpro_ajax_picupload() {
  jQuery(".userpro-pic-upload").each(function () {
    ...
    jQuery(this).uploadFile({
      url:
        userpro_ajax_url + "?action=userpro_ajax_fileupload&user_id=" + user_id,
      ...
      onSuccess: function (files, data, xhr) {
        ...
        if (statusbar.parents(".userpro-input").find("img.default").length) {
          var width = statusbar
            .parents(".userpro-input")
            .find("img.default")
            .attr("width");

          var height = statusbar
            .parents(".userpro-input")
            .find("img.default")
            .attr("height");
        } else if (
          statusbar.parents(".userpro-input").find("img.modified").length
        ) {
          var width = statusbar
            .parents(".userpro-input")
            .find("img.modified")
          ...
          statusbar.parents(".userpro-input").find("img.avatar").length
        ) {
          var width = statusbar
            .parents(".userpro-input")
            .find("img.avatar")
        ...
        str =
          "action=userpro_crop_picupload&filetype=" +
          filetype +
          "&width=" +
          width +
          "&height=" +
              ...
              .after(
                "<input type='button' value='" +
                  statusbar
                    ...
                    .find(".userpro-pic")
                    .data("remove_text") +
                  "' class='userpro-button red' style='display:none' />"
              );
            ...
            statusbar.prev().fadeIn(function () {
              if (filetype == "picture") {
                ...
                statusbar
                  .parents(".userpro-input")
                  .find("img")
                  .removeClass("no_feature");

                jQuery(".userpro-webcam-pic-upload").show();
              } else if (filetype == "file") {
                statusbar
                  .parents(".userpro-input")
                  .find(".userpro-file-input")
                  .remove();
...
function userpro_password_strength_meter(element) {
  var meter = element
    .parents(".userpro")
    .find(".userpro-field[data-key^='passwordstrength']");
  ...
  var lower = LOWER.test(password),
    upper = UPPER.test(
      password.substring(0, 1).toLowerCase() + password.substring(1)
    ),
  ...
  if (meter.length > 0) {
    if (password.length < 8) {
      ...
      meter
        .find(
          ".strength-plain:eq(0),.strength-plain:eq(1),.strength-plain:eq(2),.strength-plain:eq(3)"
        )
        .addClass("fill");
      ...
      meter
        .find(
          ".strength-plain:eq(0),.strength-plain:eq(1),.strength-plain:eq(2)"
        )
        .addClass("fill");
      ...
      meter
        .find(".strength-plain:eq(0),.strength-plain:eq(1)")
        .addClass("fill");
...
function userpro_chosen() {
  jQuery(".userpro select, .emd-filters select")
    .removeClass("chzn-done")
    .css("display", "inline")
    .data("chosen", null);

  jQuery(".userpro, .emd-filters")
    .find("*[class*=chzn], .chosen-container")
    .remove();
...
function userpro_responsive() {
  ...
  jQuery(".userpro").each(function () {
    ...
    if (upro.width() <= 400 && upro.width() > 0) {
      ...
      upro
        .find(".userpro-social-connect")
        .removeClass("fullwidth-block-social");
    }
  });
  ...
  jQuery(".userpro-users-v2").each(function () {
    ...
    if (elem.width() <= 560) {
      elem
        .find(".userpro-awsm")
        .css({ width: "100%", "margin-left": 0, "margin-right": 0 });
    }

    if (elem.width() > 700) {
      elem
        .find(".userpro-awsm")
        .css({ width: "25%", "margin-left": "15px", "margin-right": "15px" });
    }
...
function today_date() {
  ...
  var yrRange =
    dateToday.getFullYear() - 100 + ":" + (dateToday.getFullYear() + 5);
  return yrRange;
}
...
function userpro_overlay_center(container) {
  if (container.length) {
    jQuery(container).animate({
      ...
      "margin-top":
        "-" + jQuery(container).find(".userpro").innerHeight() / 2 + "px",
    });
  }
}
...
function userpro_collapse(form) {
  form.find(".userpro-section").each(function () {
    if (
      jQuery(this).next("div.userpro-field:not(.userpro-submit)").length == 0
    ) {
      jQuery(this).hide();
    } else {
    }
  ...
  form.find(".userpro-collapsible-1.userpro-collapsed-1").each(function () {
    ...
    if (jQuery(this).find("span").length == 0)
      jQuery(this).prepend(
        '<span><i class="userpro-icon-angle-right"></i></span>'
      );
  });
  ...
  form.find(".userpro-collapsible-1.userpro-collapsed-0").each(function () {
    ...
    if (jQuery(this).find("span").length == 0)
      jQuery(this).prepend(
        '<span><i class="userpro-icon-angle-down"></i></span>'
      );
  });
}
...
function userpro_side_validate(element, input_value, ajaxcheck) {
  str =
    "action=userpro_side_validate&input_value=" +
    input_value.replace(/&/g, "%26") +
    "&ajaxcheck=" +
    ajaxcheck +
    "&element=" +
    element;
  ...
  if (element.attr("type")) {
    if (element.attr("type") == "hidden") {
      ...
      if (parent.find(".userpro-warning").length == 0) {
        ...
        parent.append(
          '<div class="userpro-warning"><i class="userpro-icon-caret-up"></i>' +
            error +
            "</div>"
        );
        ...
        parent
          .find(".userpro-warning")
          .html('<i class="userpro-icon-caret-up"></i>' + error);
  ...
  if (element.attr("type")) {
    if (element.attr("type") == "radio" || element.attr("type") == "checkbox") {
      ...
      if (parent.find(".icon-ok").length == 0) {
        if (element.val() != "") {
          parent.append(
            '<div class="icon-ok"><i class="userpro-icon-ok"></i></div>'
          );
        } else {
          parent.find(".icon-ok").remove();
        }
...
function userpro_clear_form(form) {
  ...
  form
    .find("input,select,textarea,recaptcha")
    .removeClass("warning")
    .addClass("ok");
}
...
function userpro_overlay_confirmation(message) {
  ...
  jQuery("body").append(
    '<div class="userpro-modal-inner"><i class="userpro-icon-ok"></i><i class="userpro-icon-remove"></i>' +
      message +
      "</div>"
  );
...
jQuery(document).ready(function () {
  ...
  jQuery(document).on(
    "click",
    ".userpro-bar-success i, .userpro-bar-failed i",
    function (e) {
  ...
  jQuery(document).on(
    "mouseenter",
    ".userpro-post:not(.userpro-post-compact)",
    function (e) {
      jQuery(this)
        .find("span.shadowed")
        .stop()
  ...
  jQuery(document).on(
    "click",
    ".userpro-alert input[type=button]",
    function (e) {
      var parent = jQuery(this).parents(".userpro-alert");

      var content = jQuery(this)
        .parents(".userpro-alert")
        .find(".userpro-alert-content");
      ...
      jQuery.ajax({
        ...
        data:
          "action=userpro_save_userdata&field=userpro_alert&value=" +
          value +
          "&user_id=" +
          user_id,
        ...
        success: function (data) {
          if (content.length == 0) {
            jQuery(this)
              .parents(".userpro-alert")
              .prepend(
                '<div class="userpro-alert-content">' + data.res + "</div>"
              );
          } else {
  ...
  jQuery(document).on(
    "submit",
    ".userpro form:not(.userpro-search-form)",
    function (e) {
      e.preventDefault();
        ...
        .animate(
          {
            top:
              "-" +
              jQuery(this).parents(".userpro").data("memberlist_pic_size") +
              "px",
          },
          50
        );
  ...
  jQuery(document).ready(function () {
    ...
    jQuery(
      'div.userpro-input input[type="text"], textarea, div.userpro-input input[type="password"]'
    ).change(function () {
      check_condition();
    });
  ...
  function check_condition(form, onload) {
    ...
    form.find(".userpro-field").each(function () {
      var condition_fields = jQuery(this)
        .find(
          'input[type=text], input[type=password], select, textarea, input[type=checkbox], input[type=radio], [data-filetype="file"]'
        )
        .data("condition_fields");

      var add_condition = jQuery(this)
        .find(
          'input[type=text], input[type=password], select, textarea, input[type=checkbox], input[type=radio],[data-filetype="file"]'
        )
        .data("add_condition");
      ...
      var conditional = jQuery(this)
        .find(
          'input[type=text], select, input[type=password], textarea, input[type=checkbox], input[type=radio],[data-filetype="file"]'
        )
        .data("condition_rule");
      ...
      if (typeof conditional != "undefined" && conditional != "") {
        var val = jQuery(
          "input[id^=" +
            ...
            condition_fields +
            "]:checked, input[type=checkbox][name^=" +
            condition_fields +
            "]:checked "
        ).val();

        var conditional_val = jQuery(this)
          .find(
            'input[type=text], input[type=password], textarea, select, input[type=checkbox], input[type=radio],[data-filetype="file"]'
          )
          .data("condition_value");

        if (conditional == "empty") {
          if (val == "" || val.length == 1) {
            if (add_condition == "hide") jQuery(this).hide();
            else jQuery(this).show();

            if (!onload) jQuery(this).addClass("has_condition");
          } else {
            if (add_condition == "hide") jQuery(this).show();
            else jQuery(this).hide();

            if (!onload) jQuery(this).removeClass("has_condition");
          }
        }
        ...
        if (
          jQuery(this)
            .prevAll(".userpro-section:first")
            .hasClass("userpro-collapsed-1")
        ) {
          jQuery(this)
            .prevAll(".userpro-section:first")
            .nextUntil("div.userpro-column")
            .hide();
        }
      }
    });
    ...
    function (e) {
      ...
      if (
        ...
        form.find("input,textarea").each(function () {
          if (
            !(jQuery(this).parents(".userpro-field").css("display") == "none")
          ) {
            jQuery(this).trigger("blur");
          }
        });
        ...
        form
          .find("div.chosen-container.chosen-container-multi ul.chosen-choices")
          .each(function () {
            ...
            required = form
              ...
              .attr("chosen-required");
            if (
              typeof jQuery(this).find("li.search-choice").val() ===
                "undefined" &&
              required == 1
            ) {
              userpro_client_error_irregular(
                jQuery(this),
                jQuery(this).parents(".chosen-container"),
                jQuery(this).parents(".userpro").data("required_text")
              );
            } else {
              userpro_client_valid(
                jQuery(this).find(".chosen-container"),
                jQuery(this).parents(".userpro-input")
              );
            }
          });

        form
          .find("select[data-required=1],textarea[data-required=1]")
          .each(function () {
            if (!jQuery(this).val()) {
              userpro_client_error_irregular(
                jQuery(this),
        ...
        form.find(".userpro-maxwidth[data-required=1]").each(function () {
          if (!jQuery(this).find("input:checkbox").is(":checked")) {
            userpro_client_error_irregular(
              "",
              jQuery(this).find(".userpro-input"),
              jQuery(this).data("required_msg")
            );
          } else {
            userpro_client_valid(
              jQuery(this).find("input:checkbox"),
        ...
        if (
          form.find(".userpro-warning").length > 0 ||
          form.find(".warning").length > 0
        ) {
          form.find(".userpro-section").each(function () {
            ...
            if (
              jQuery(this)
                .nextUntil("div.userpro-column")
                .find(".userpro-warning").length > 0
            ) {
              jQuery(this).css({ display: "block" });

              jQuery(this).append(
                '<ins class="userpro-section-warning">' +
                  userpro_frontend_publisher_data.correction_text +
                  "</ins>"
              );
      ...
      if (
        jQuery(this)
          .parents(".userpro")
          .find(".userpro-profile-img-btn a")
          .data("up_username")
      ) {
        up_username = jQuery(this)
          .parents(".userpro")
          .find(".userpro-profile-img-btn a")
          .data("up_username");
      } else {
      ...
      jQuery.ajax({
        ...
        data:
          form.serialize() +
          "&action=userpro_process_form&template=" +
          form_data["template"] +
          "&group=" +
          form_data[form_data["template"] + "_group"] +
          "&shortcode=" +
        ...
        success: function (data) {
          ...
          if (data && data.error) {
            ...
            jQuery.each(data.error, function (key, value) {
              ...
              if (key == "antispam" || key == "user_email") {
                element = form
                  .find('.userpro-field[data-key="' + key + '"]')
                  .find("input[type=text]");
              } else {
                element = form
                  .find('.userpro-field[data-key="' + key + '"]')
              ...
              if (
                ...
                userpro_client_error_irregular(
                  element,
                  element.parents(".userpro-input"),
                  value
                );
              } else {
                if (i == 1) element.focus();

                userpro_client_error(
                  element,
                  element.parents(".userpro-input"),
                  value
                );
              ...
              if (key == "userpro_editor") {
                if (
                  form
                    .find(".userpro-field-editor .userpro-input")
                    .find(".userpro-warning").length
                ) {
                  form
                    .find(".userpro-field-editor .userpro-input")
                    .find(".userpro-warning")
          ...
          if (data && data.custom_message && data.custom_message != "") {
            form
              .parents(".userpro")
              .find(".userpro-body")
              .find(".userpro-message")
              .remove();

            form
              .parents(".userpro")
              .find(".userpro-body")
              .prepend(data.custom_message);
          }
          ...
          if (data && data.template && data.template != "") {
            ...
            if (form_data["template"] == "edit") {
              userpro_overlay_confirmation(
                form.parents(".userpro").data("modal_profile_saved")
              );
            }
          }
          ...
          if (data !== null) {
            if (!data.error && form_data["template"] == "publish") {
              form
                .find("input,textarea")
                .not("input[type=submit],input[type=hidden],input[type=button]")
                .val("");

              form
                .find("div.userpro-pic-post_featured_image img")
                .addClass("no_feature");
  ...
  function validate_format($input) {
    $input = $input.split("-");
    if ($input[2] > 0 && $input[1] > 0 && $input.length == 3) {
      //month
      return true;
    }
    return false;
  ...
  jQuery(document).on(
    "blur",
    ".userpro[data-template=publish] textarea, .userpro[data-template=publish] input, .userpro[data-template=register] input, .userpro[data-template=edit] input, .userpro[data-template=change] input",
    function (e) {
      ...
      var original_elem = element
        .parents(".userpro")
        .find("input[type=password]:first");
      ...
      if (required == 1) {
        if (element.val().replace(/^\s+|\s+$/g, "").length == 0) {
          userpro_client_error(
            element,
            element.parents(".userpro-input"),
            element.parents(".userpro").data("required_text")
          );
        } else if (
          !validate_format(element.val()) &&
          element.attr("data-fieldtype") == "datepicker"
        ) {
          userpro_client_error(
            element,
            element.parents(".userpro-input"),
            element.parents(".userpro").data("datepicker_format")
          );
        } else if (ajaxcheck) {
        ...
        if (jQuery(this).attr("type") == "password") {
          ...
          if (element.val().replace(/^\s+|\s+$/g, "").length == 0) {
            ...
            userpro_client_error(
              element,
              element.parents(".userpro-input"),
              element.parents(".userpro").data("password_too_short")
            );
          } else if (userpro_password_strength_meter(element) < 3) {
            userpro_client_error(
              element,
              element.parents(".userpro-input"),
              element.parents(".userpro").data("password_not_strong")
            );
          } else if (original != element.val()) {
            userpro_client_error(
              element,
              element.parents(".userpro-input"),
              jQuery(this).parents(".userpro").data("passwords_do_not_match")
            );
          } else {
            userpro_client_valid(element, element.parents(".userpro-input"));
          }
        ...
        original_elem &&
        original &&
        original_elem.parents(".userpro-input").find(".userpro-warning")
          .length == 0
      ) {
        if (element.val().replace(/^\s+|\s+$/g, "").length == 0) {
          userpro_client_error(
        ...
        (element.attr("type") == "password" && original) ||
        (element.attr("type") == "password" &&
          element.parents(".userpro").data("template") == "change")
      ) {
        if (element.val().replace(/^\s+|\s+$/g, "").length == 0) {
          userpro_client_error(
            element,
      ...
      else if (element.val() && element.data("sitekey") != "") {
        //userpro_clear_input(element);
      }
    }
  );
  ...
  jQuery(document).on(
    "change",
    ".userpro[data-template=register] select",
    function (e) {
      var element = jQuery(this);
  ...
  jQuery(document).on(
    "keyup keydown",
    ".userpro[data-template=register] input[type=password][data-required=1]",
    function (e) {
  ...
  jQuery(document).on(
    "keyup keydown",
    ".userpro[data-template=edit] input[type=password]:first",
    function (e) {
      userpro_password_strength_meter(jQuery(this));
    }
  );
  ...
  jQuery(document).on(
    "keyup keydown",
    ".userpro[data-template=change] input[type=password]:first",
    function (e) {
      userpro_password_strength_meter(jQuery(this));
    }
  );
  ...
  jQuery(document).on("click", ".userpro-collapsible-1", function (e) {
    if (
      ...
      jQuery(this)
        .removeClass("userpro-collapsed-1")
        .addClass("userpro-collapsed-0");

      jQuery(this).find("span").html('<i class="userpro-icon-angle-down"></i>');

      if (jQuery(this).parents(".userpro").data("keep_one_section_open") == 1) {
        jQuery(".userpro-collapsible-1.userpro-collapsed-0")
          .not(this)
          .nextUntil("div.userpro-column")
          .hide();
        ...
        jQuery(".userpro-collapsible-1.userpro-collapsed-0")
          .not(this)
          .find("span")
          .html('<i class="userpro-icon-angle-right"></i>');

        jQuery(".userpro-collapsible-1.userpro-collapsed-0")
          .not(this)
          .removeClass("userpro-collapsed-0")
          .addClass("userpro-collapsed-1");
      }
    } else {
      jQuery(this).nextUntil("div.userpro-column").hide();
  ...
  jQuery(document).on(
    "click",
    "*[class^='popup_userpro-'],*[class^='popup_userpro-'] a",
    function (e) {
      ...
      if (jQuery("body").find(".userpro-overlay").length == 0) {
        jQuery("body").append(
          '<div class="userpro-overlay"/><div class="userpro-overlay-inner"/>'
        );
      }

      userpro_shortcode_template(
        "insert",
        jQuery(".userpro-overlay-inner"),
        shortcode,
        up_username
      );
  ...
  jQuery(document).on("change", "input[name^='gender']", function (e) {
    ...
    if (
      this_form.find("*[data-key=profilepicture]").find("input:hidden").val() ==
      ""
    ) {
      this_form
        .find("*[data-key=profilepicture]")
        .find("img")
        .attr(
          "src",
          jQuery(this)
            .parents(".userpro")
            .data("default_avatar_" + jQuery(this).val().toLowerCase())
        );
    }
  });
  ...
  jQuery(document).on(
    "click",
    ".userpro form:not(.userpro-search-form) .userpro-input .userpro-button.red",
    function (e) {
      ...
      if (jQuery(this).parents(".userpro-input").find("img.default").length) {
        ...
        if (
          jQuery(this)
            .parents(".userpro")
            .find("div.userpro-pic-post_featured_image").length
        ) {
          jQuery(this)
            .parents(".userpro-input")
            .find("img.modified")
            ...
            .attr(
              "src",
              jQuery(this).parents(".userpro-input").data("placeholder")
            );
        } else {
          jQuery(this)
            .parents(".userpro-input")
      ...
      if (
        jQuery(this).parents(".userpro-input").find(".userpro-file-input")
          .length
      ) {
        jQuery(this)
          .parents(".userpro-input")
  ...
  jQuery("#inviteuser").submit(function (e) {
    ...
    jQuery.post(userpro_ajax_url, data, function (response) {
      ...
      if (response == "Not a valid email address") {
        ...
        jQuery("#invite_success_msg").html(
  ...
  if (retVal == true) {
    jQuery.ajax({
      ...
      success: function (data) {
        ...
        else jQuery(elm).parent().parent().remove();
      },
...
function up_initialize_webcam(elm) {
  ...
  var up_data =
    "<div class='up-capture-photo' id='up-capture-photo' onclick=up_capture_image('" +
    up_key +
    "')>Take Photo</div>";
  ...
  jQuery(".userpro-overlay-inner").html(
    "<div class='userpro'><div class='userpro-centered'  style='height:400px;'><div id='up-webcam-pic' style='width:400px;height:300px'></div></div></div>"
  );
...
function up_capture_image(elm) {
  var elem = jQuery('div[data-key="' + elm + '"]').find(
      ...
      jQuery.ajax({
        ...
        success: function (data) {
          elem
            ...
            .after(
              "<input type='button' value='" +
                elem.parent().find(".userpro-pic").data("remove_text") +
                "' class='userpro-button red' style='display:none' />"
            );
  ...
  if (typeof userpro_frontend_publisher_data !== "undefined") {
    jQuery("select[name^='post_categories']").chosen({
      max_selected_options:
        userpro_frontend_publisher_data.userpro_limit_categories,
